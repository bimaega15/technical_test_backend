...
import TypeLeaveService from "../service";

class TypeLeaveController implements IController {
  index = async (req: Request, res: Response) => {
    try {
      const services: TypeLeaveService = new TypeLeaveService(req);
...
export default new TypeLeaveController();
