...
import TypeAbsenceService from "../service";

class TypeAbsenceController implements IController {
  index = async (req: Request, res: Response) => {
    try {
      const services: TypeAbsenceService = new TypeAbsenceService(req);
...
export default new TypeAbsenceController();
